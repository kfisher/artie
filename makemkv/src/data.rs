...
///
/// This value is a lot higher that what the actual maximum number of streams that will be. Its main
/// purpose is to protect against an error in coding or bad data being generated by MakeMKV causing
/// an infinite (or extremely large) number of streams being added.
...
pub struct StreamInfo {
    /// Map containing the attributes of the stream where each key is the attribute id and the value
    /// is the attribute's value.
    pub attributes: HashMap<Attribute, String>,
}
...
impl DiscInfo {
    ...
    pub(crate) fn add_attribute(&mut self, attr: Attribute, value: &str) -> Result<()> {
    ...
    pub(crate) fn add_title_attribute(
        &mut self,
        index: usize,
        attr: Attribute,
        value: &str,
    ...
    pub(crate) fn add_stream_attribute(
        &mut self,
        title_index: usize,
        stream_index: usize,
        attr: Attribute,
